...
import { Play, Square, Plus, Navigation, Clock, Target, TrendingUp, Zap, MapPin, Fuel, CheckCircle2, XCircle, ClipboardCheck, Mic, MicOff, Wallet, AlertTriangle, BookOpen, Satellite, Gauge, Wifi } from "lucide-react";
...
export default function RiderDashboard() {
  ...
  const { addDailyLog, settings, addShift: fbAddShift, editShift: fbEditShift, addTrip: fbAddTrip, addFuelLog, riderLocations } =
